                    ...
                    <div key={index}>
                        ...
                        <div className="product-list">
                            ...
                            <div className="product-card" key={plantIndex}>
                                ...
                                { cart.find(item => item.name === plant.name) !== undefined ? (<button className="product-button" onClick={() => handleAddToCart(plant)}>Add to Cart</button>) : (<button disabled className="product-button">Added to Cart</button>)}
